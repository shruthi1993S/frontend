...
var DropdownItem2 = React12.forwardRef(({
  ...
  return (0, import_jsx_runtime9.jsx)(Component, {
    ...
    ...dropdownItemProps,
    ref,
    className: (0, import_classnames2.default)(className, prefix, meta.isActive && "active", disabled && "disabled")
  });
});
...
var DropdownMenu2 = React16.forwardRef(({
  ...
  return (0, import_jsx_runtime11.jsx)(Component, {
    ...
    className: (0, import_classnames4.default)(className, prefix, show && "show", alignEnd && `${prefix}-end`, variant && `${prefix}-${variant}`, ...alignClasses)
  });
});
...
//# sourceMappingURL=chunk-77F5BVEN.js.map
